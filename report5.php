...
$field = $_POST['field'];
$value = $_POST['fvalue'];
$result5 =mysqli_query($con, "SELECT * FROM   offers where $field like '%$value%' && status='Stocked'  ORDER BY id DESC");
	}
?>

	<section role="main" class="content-body">
					<header class="page-header">
						<h2>Vendors billing report for a specific Month</h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Vendors billing report for a specific Month</span></li>
							</ol>
							...
							<div class="col-lg-12">
								<section class="panel">
									<div class="panel-body">
										<form class="form-horizontal form-bordered" action="report5.php" method="post">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<div class="input-group">
														...
														<input type="text" id="month" name="fvalue" class="monthPicker" value="<?= $value?>"/>
						...
						<section class="panel" id="HTMLtoPDF">
							<header class="panel-heading">
								<h2 class="panel-title">Vendors billing report for a specific Month</h2>
