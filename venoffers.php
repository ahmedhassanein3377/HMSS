					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								<h2 class="panel-title">Dear &nbsp; <b><?php echo $row['fname']; ?>&nbsp;<?php echo $row['lname']; ?> </b>&nbsp;thats your Offers Status</h2>
							</header>
...
<?php
	...
	$stmt = $DB_con->prepare("SELECT * FROM offers where email = '$_COOKIE[user]'ORDER BY id DESC");
	$stmt->execute();
	if($stmt->rowCount() > 0)
	{
