...
?>
<?php
$sql="UPDATE offers SET ntf=2 WHERE ntf=1";	
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Requested Orders</span></li>
							</ol>
						...
						<section class="panel">
							<header class="panel-heading">
								<h2 class="panel-title">Dear &nbsp; <b><?php echo $row['fname']; ?>&nbsp;<?php echo $row['lname']; ?> </b>&nbsp;thats your Requested Orders</h2>
							</header>
...
<?php
	...
	$stmt = $DB_con->prepare("SELECT * FROM offers where email = '$_COOKIE[user]' && status='Ordered' ORDER BY id DESC");
	$stmt->execute();
	if($stmt->rowCount() > 0)
	{
